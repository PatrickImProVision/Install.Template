-- Technology stack CMS (MySQL / MariaDB).
...
CREATE TABLE IF NOT EXISTS `tech_stack_items` (
  ...
  `icon_color` VARCHAR(32) NULL DEFAULT NULL,
  `name_color` VARCHAR(32) NULL DEFAULT NULL,
  `icon_svg` TEXT NULL,
  `created_at` DATETIME NULL DEFAULT NULL,
  `updated_at` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tech_stack_items_sort_idx` (`sort_order`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT IGNORE INTO `tech_stack_items` (`id`, `sort_order`, `kind`, `title`, `description`, `category`, `product_name`, `blurb`, `href`, `icon_color`, `name_color`, `icon_svg`, `created_at`, `updated_at`) VALUES
(1, 0, 'page_heading', 'Technology stack', 'We use modern, reliable technology to maximize performance and security', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NOW(), NOW()),
