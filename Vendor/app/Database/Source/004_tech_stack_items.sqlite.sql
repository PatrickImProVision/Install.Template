-- Technology stack CMS (SQLite 3).

CREATE TABLE IF NOT EXISTS tech_stack_items (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  sort_order INTEGER NOT NULL DEFAULT 0,
  kind TEXT NOT NULL DEFAULT 'tech_card',
...
INSERT OR IGNORE INTO tech_stack_items (id, sort_order, kind, title, description, category, product_name, blurb, href, icon_color, name_color, icon_svg, created_at, updated_at) VALUES
(1, 0, 'page_heading', 'Technology stack', 'We use modern, reliable technology to maximize performance and security', NULL, NULL, NULL, NULL, NULL, NULL, NULL, datetime('now'), datetime('now')),
...
(9, 80, 'tech_card', '', NULL, 'Network & security', 'Cloudflare', 'CDN, DDoS protection, and DNS services', 'https://www.cloudflare.com', '#d97706', '#d97706', '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/></svg>', datetime('now'), datetime('now'));
