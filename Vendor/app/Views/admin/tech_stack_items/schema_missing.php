...
<body>
<header>
    <h1><?= esc($title ?? 'Technology stack CMS') ?></h1>
    <nav>
...
<main>
    <div class="panel">
        <p>The <code>tech_stack_items</code> table is not in the database yet.</p>
        <p>Import the preset script for your driver from <code>app/Database/Source/</code>:</p>
        <ul>
            <li>MySQL / MariaDB: <code>004_tech_stack_items.sql</code></li>
            <li>SQLite: <code>004_tech_stack_items.sqlite.sql</code></li>
            <li>PostgreSQL: <code>004_tech_stack_items.pgsql.sql</code></li>
            <li>SQL Server: <code>004_tech_stack_items.sqlsrv.sql</code></li>
        </ul>
        ...
        <p><a href="<?= esc(site_url('DashBoard/Tech_Stack')) ?>">Reload this page</a> after importing.</p>
    </div>
</main>
</body>
</html>
