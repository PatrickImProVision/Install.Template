...
<main>
    <div class="panel">
        <p>The <code>contact_items</code> table is not in the database yet.</p>
        <p>Import the preset script for your driver from <code>app/Database/Source/</code>:</p>
        <ul>
            <li>MySQL / MariaDB: <code>007_contact_items.sql</code></li>
            <li>SQLite: <code>007_contact_items.sqlite.sql</code></li>
            <li>PostgreSQL: <code>007_contact_items.pgsql.sql</code></li>
            <li>SQL Server: <code>007_contact_items.sqlsrv.sql</code></li>
        </ul>
        ...
        <p><a href="<?= esc(site_url('DashBoard/Site_Contacts')) ?>">Reload this page</a> after importing.</p>
    </div>
</main>
</body>
</html>
