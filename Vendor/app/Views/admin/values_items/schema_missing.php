...
<body>
<header>
    <h1><?= esc($title ?? 'Our values CMS') ?></h1>
    <nav>
...
<main>
    <div class="panel">
        <p>The <code>values_items</code> table is not in the database yet.</p>
        <p>Import the preset script for your driver from <code>app/Database/Source/</code>:</p>
        <ul>
            <li>MySQL / MariaDB: <code>006_values_items.sql</code></li>
            <li>SQLite: <code>006_values_items.sqlite.sql</code></li>
            <li>PostgreSQL: <code>006_values_items.pgsql.sql</code></li>
            <li>SQL Server: <code>006_values_items.sqlsrv.sql</code></li>
        </ul>
        ...
        <p><a href="<?= esc(site_url('DashBoard/Values')) ?>">Reload this page</a> after importing.</p>
    </div>
</main>
</body>
</html>
