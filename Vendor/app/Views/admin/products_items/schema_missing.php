...
<main>
    <div class="panel">
        <p>The <code>products_items</code> table is not in the database yet.</p>
        <p>Import the preset script for your driver from <code>app/Database/Source/</code>:</p>
        <ul>
            <li>MySQL / MariaDB: <code>005_products_items.sql</code></li>
            <li>SQLite: <code>005_products_items.sqlite.sql</code></li>
            <li>PostgreSQL: <code>005_products_items.pgsql.sql</code></li>
            <li>SQL Server: <code>005_products_items.sqlsrv.sql</code></li>
        </ul>
        ...
        <p><a href="<?= esc(site_url('DashBoard/Products')) ?>">Reload this page</a> after importing.</p>
    </div>
</main>
</body>
</html>
