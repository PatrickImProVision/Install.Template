...
<div class="site-main services-page-main">
<?= view('partials/site_header', ['installed' => $installed, 'siteName' => $siteName, 'navCurrent' => 'services']) ?>

<?= view('partials/services_section', [
    'installed'             => $installed,
    'servicesHeading'       => $servicesHeading ?? null,
    'serviceCards'          => $serviceCards ?? [],
    'servicesUnavailable'   => $servicesUnavailable ?? false,
    'servicesSchemaMissing' => $servicesSchemaMissing ?? false,
]) ?>
